                            ...
                            <div class="row">
                                <div class="col-4">
                                    <a target="_blank"
                                        ...
                                        ng-href="https://www.facebook.com/sharer/sharer.php?u={{ ::item.url }}&quote={{ ::item.intro.substring(0, 500) }}%2E%2E%2E"></a>
                                </div>
                                <div class="col-4">
                                    <a target="_blank"
                                        class="icon-dropdown icon-twitter pr-5"
                                        ng-href="https://twitter.com/intent/tweet?url={{ ::item.url }}&text={{ ::item.intro.substring(0, 200) }}%2E%2E%2E"></a>
                                </div>
                                <div class="col-4">
